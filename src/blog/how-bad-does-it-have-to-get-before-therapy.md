...
ogType: article
ogUrl: "https://therapybydavid.com/blog/how-bad-does-it-have-to-get-before-therapy"
canonical: "https://therapybydavid.com/blog/how-bad-does-it-have-to-get-before-therapy"
permalink: "/blog/how-bad-does-it-have-to-get-before-therapy.html"
date: 2026-08-20
order: 50
tag: "Mental Health"
dateDisplay: "August 20, 2026 · 9 min read"
deck: "Most people wait until they're barely functioning to ask for help. Here's why that threshold is worth questioning, and what actually matters more than how bad it feels."
cardTitle: "How Bad Does It Have to Get Before Therapy Makes Sense?"
...
cardDate: "August 20, 2026 · 9 min read"
ctaHeading: "Ready to work on this?"
ctaText: "Schedule a free 15-minute consultation. No pressure, and no threshold you have to meet first, just a real conversation about what you're noticing."
faqJson: |
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How bad does it have to get before therapy makes sense?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "There is no severity threshold you have to cross. Therapy is not only for crisis or diagnosis. If something has been taking up space in your head for a while, if it is affecting more than one part of your life, or if you keep running into the same pattern, that is enough of a reason to talk to someone. Waiting until it becomes undeniable usually means working through more layers later."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No. Most people do not begin with a clear diagnosis or a tidy explanation. They begin with a sense that something is off, heavier, or harder than it should be. Part of the early work is putting language around that: when it started, what sets it off, what you have already tried, and what it is costing you."
        }
      },
      {
        "@type": "Question",
        "name": "Is it a problem if I'm still functioning?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Functioning and struggling are not opposites. Many people carry real distress while still working, parenting, and meeting every obligation. Being able to keep going is often evidence of good coping in front of other people rather than evidence that nothing is wrong. High-functioning anxiety and depression can go unexamined for years for exactly this reason."
        }
      },
      {
        "@type": "Question",
        "name": "What actually determines whether it's time for therapy?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Three things matter more than severity. Duration: how long it has been running, not how intense it feels. Spread: whether it is staying in one part of your life or leaking into your sleep, relationships, and time off. Repetition: whether you have been here before and can name earlier versions of the same ending. None of those require a crisis to answer."
        }
      },
      {
        "@type": "Question",
        "name": "When should I not wait to get help?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Some situations are worth addressing right away rather than watching a while longer: thoughts of harming yourself, using alcohol or substances more often to get through ordinary days, sleep that has been broken for weeks, not being able to manage basics like eating or getting to work, or feeling unsafe with someone. If you are in immediate danger or thinking about ending your life, call or text 988 to reach the Suicide and Crisis Lifeline, or go to your nearest emergency room."
        }
      }
    ]
  }
...
None of these require a diagnosis to be worth talking about. If you've found yourself wondering [how you'd even know if something like anxiety has crossed the line into a real problem](https://therapybydavid.com/blog/how-anxiety-becomes-a-problem), the fact that you're wondering is usually information worth paying attention to.
...
This is especially true for people whose anxiety or low mood hides behind competence. [High-functioning anxiety](https://therapybydavid.com/blog/high-functioning-anxiety) often looks like being reliable, prepared, and slightly ahead of everything, and it can go unexamined for years precisely because the outward results look good. The performance keeps working right up until it doesn't.
...
If you're curious what that first conversation actually involves, [this breakdown of what to expect in a first session](https://therapybydavid.com/blog/first-therapy-session) covers the practical side, so at least that part isn't a mystery going in.
...
Cost is a real consideration for people, and it's worth understanding what therapy actually runs in this state and what the options are before assuming it's out of reach. [Here's a clear look at what therapy costs in Texas](https://therapybydavid.com/blog/therapy-cost-texas). Scheduling is another one, and it's part of why [telehealth versus in-person](https://therapybydavid.com/blog/online-vs-in-person-therapy) is worth thinking through honestly, since one of those removes a commute and the other gives you a room to walk into. And if the obstacle is that the search itself feels overwhelming, [this walks through how to actually find a therapist in Houston](https://therapybydavid.com/blog/find-a-therapist-houston-texas) without spending a month on it.
...
There's a related trap worth naming, which is [waiting to feel ready before changing anything](https://therapybydavid.com/blog/waiting-to-feel-ready-before-you-change-anything). Readiness is usually something that develops after you start, not a prerequisite you have to arrive with. The same is true here. Most people don't feel certain when they make the call. They feel a little uncomfortable and do it anyway.
